...
export default function Home() {
  ...
  const sendChat = (e) => {
    e.preventDefault();
    socket.emit('sendMessage', { message, id: nanoid(8) });
    setMessage('');
  };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <main className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <form className="w-full mt-20">
          ...
          {/* show MessageId in span */}
          <span
            className="border border-gray-300 rounded-l px-3 py-2 outline-none focus:shadow-outline"
            type="text"
            value="640c0b1f4f64f71f1ac88b15">640c0b1f4f64f71f1ac88b15</span>
            
          <li
            className="border border-gray-300 rounded-l px-3 py-2 outline-none focus:shadow-outline"
            type="text"
            value="640c0b1f4f64f71f1ac88b15">640c0b1f4f64f71f1ac88b15</li>
